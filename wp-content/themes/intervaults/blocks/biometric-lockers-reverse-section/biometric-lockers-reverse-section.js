(function () {
  ...
  function syncCardHeights(slots, forcedHeight) {
    ...
    slots.forEach(function (slot) {
      ...
      var card = slot.querySelector(".biometric-lockers-reverse__card");
      if (!card) {
        return;
      }
  ...
  function renderSlot(slot, item) {
    var image = slot.querySelector(".biometric-lockers-reverse__image");
    var imageWrap = slot.querySelector(".biometric-lockers-reverse__image-wrap");
    var icon = slot.querySelector(".biometric-lockers-reverse__icon");
    var cardTitle = slot.querySelector(".biometric-lockers-reverse__card-title");
    var cardDesc = slot.querySelector(".biometric-lockers-reverse__card-desc");
    var meta = slot.querySelector(".biometric-lockers-reverse__meta");
  ...
  function initBlock(block) {
    ...
    var datasetNode = block.querySelector(".biometric-lockers-reverse__dataset");
    var slotsWrap = block.querySelector(".biometric-lockers-reverse__slots");
    var controls = Array.from(block.querySelectorAll(".biometric-lockers-reverse__controls"));
    var prevButtons = Array.from(block.querySelectorAll(".biometric-lockers-reverse__control--prev"));
    var nextButtons = Array.from(block.querySelectorAll(".biometric-lockers-reverse__control--next"));
    var slots = Array.from(block.querySelectorAll(".biometric-lockers-reverse__slot"));
    ...
    var renderAll = function () {
      ...
      if (slotWidth > 0) {
        ...
        var probeCard = probe.querySelector(".biometric-lockers-reverse__card");
        var maxHeight = 0;
  ...
  function initAll(scope) {
    ...
    var blocks = root.querySelectorAll(".biometric-lockers-reverse");
  ...
  function registerAcfHooks() {
    ...
    window.acf.addAction("render_block_preview/type=biometric-lockers-reverse-section", onRender);
    window.acf.addAction("render_block_preview/type=acf/biometric-lockers-reverse-section", onRender);
    return true;
  }
